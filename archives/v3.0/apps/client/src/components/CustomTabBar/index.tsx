...
export default function CustomTabBar() {
  ...
  useEffect(() => {
    ...
    if (role === 'customer') {
      ...
      const index = customerTabs.findIndex(function(tab) { return route.includes(tab) })
      ...
      const index = staffTabs.findIndex(function(tab) { return route.includes(tab) })
      setSelected(index >= 0 ? index : 0)
    }
  }, [role])
  ...
  // 员工角色的TabBar
  const staffTabs = [
    { text: '看板', icon: '📊', url: '/pages/dashboard/index' },
    { text: '客户', icon: '👤', url: '/pages/customer/index' },
    { text: '员工', icon: '👔', url: '/pages/staff/index' },
    ...
    { text: '导入', icon: '📥', url: '/pages/import/index' },
    { text: '清理', icon: '🧹', url: '/pages/cleanup/index' },
    { text: '同步', icon: '🔄', url: '/pages/sync/index' },
    { text: '我的', icon: '👤', url: '/pages/profile/index' }
  ]
