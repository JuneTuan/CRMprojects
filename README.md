...
JunLite CRM V5.2R1 是一个完整的客户关系管理系统，采用现代化的前后端分离架构，提供管理端和H5前端双端支持。

### 核心特性

- 🎯 **完整的功能模块**：客户管理、产品管理、订单管理、优惠券管理、活动管理、抽奖系统、员工管理、统计分析、审计日志、会员等级系统、文件上传
...
GET    /audit-logs/statistics   # 获取审计日志统计
```
